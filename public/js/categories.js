...
$(document).ready(function() {
	...
	$('#addCategoriesModalBtn').unbind('click').bind('click', function() {
		...
		$("#submitCategoriesForm").unbind('submit').bind('submit', function() {
			...
			if(categoriesCode == "") {
				$("#categoriesCode").after('<p class="text-danger">กรุณากรอกรหัสประเภทครุภัณฑ์</p>');
			...
			if(categoriesName == "") {
				$("#categoriesName").after('<p class="text-danger">กรุณากรอกประเภทครุภัณฑ์</p>');
			...
			if(categoriesCode && categoriesName) {
				var form = $(this);
				// button loading
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#editCategoriesForm").unbind('submit').bind('submit', function() {
					...
					if(categoriesCode == "") {
						$("#editCategoriesCode").after('<p class="text-danger">กรุณากรอกรหัสประเภทครุภัณฑ์</p>');
