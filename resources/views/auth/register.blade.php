    ...
    <div class="tab-content">
        ...
        <div id="regisTeach" class="container tab-pane active">
            ...
            <form method="POST" action="{{ route('register') }}}">
                ...
                &nbsp;<span class="badge badge-info" style="font-weight:normal;">(ใช้ @kkumail.com เท่านั้น)</span>
                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                    value="{{ old('email') }}" placeholder="user@kku.ac.th" required autocomplete="email">
                @error('email')
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                <input id="user_id" type="text" class="form-control @error('user_id') is-invalid @enderror"
                    ...
                    OnKeyPress="return chkNumber(this)" pattern="[0-9]{8,8}.[-].[0-9]{0,0}" placeholder="60302xxxx-x"
            ...
            &nbsp;<span class="badge badge-info" style="font-weight:normal;">(ใช้ @kkumail.com เท่านั้น)</span>
            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                value="{{ old('email') }}" placeholder="user@kkumail.com" required autocomplete="email">
            @error('email')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
